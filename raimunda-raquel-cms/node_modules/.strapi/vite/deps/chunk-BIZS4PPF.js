import {
  ...
  StageColumn,
  getDisplayName
} from "./chunk-US2KLF7O.js";
import {
  buildValidParams as buildValidParams2
} from "./chunk-AK5CFNWL.js";
import {
  getStageColorByHex
} from "./chunk-ZTUYDLKS.js";
import {
  LimitsModal
} from "./chunk-6MGCLBEP.js";
import {
...
} from "./chunk-DJDG5U46.js";
import {
  useTypedSelector
} from "./chunk-CABAEXZK.js";
import {
  ...
  useGetLocalesQuery,
  useGetSettingsQuery
} from "./chunk-6DX64B75.js";
import {
  ReleaseActionMenu,
  ReleaseActionOptions
} from "./chunk-7KOGQYWC.js";
import {
  index
} from "./chunk-7GOC3JYY.js";
import {
...
import {
  ...
  usePersistentState,
  useSelectionState
} from "./chunk-M5NTRAT6.js";
import {
  useConfig,
  useTracking
} from "./chunk-RZZXH6AK.js";
import {
  AssetSource,
  AssetType,
...
import {
  useDocumentActions
} from "./chunk-2L27HN4F.js";
import {
  buildValidParams,
  useContentManagerContext,
  useDocument,
  useDocumentLayout
} from "./chunk-QZR2L3CL.js";
import {
  renderAdmin
} from "./chunk-4VZ7UILZ.js";
import {
  useAIAvailability
} from "./chunk-5WFOYS37.js";
import {
  useLicenseLimits
} from "./chunk-23XGRNTX.js";
import {
  Table,
  useTable
} from "./chunk-TGKNSLOB.js";
import {
  useField,
  useForm
...
var index2 = {
  register(app) {
    ...
    app.addMenuLink({
      ...
      Component: () => import("./App-3LC2H3AX.js"),
      position: 5
    });
    app.registerPlugin({
      id: pluginId,
  ...
  register(app) {
    app.createSettingSection({
    ...
    }, [
      {
        ...
        id: "settings",
        to: "email",
        Component: () => import("./Settings-7AXNQ7GR.js").then((mod) => ({
            ...
            (assetCount > 0 || folderCount > 0 || isFiltering) && (0, import_jsx_runtime6.jsxs)(Flex, {
              ...
              children: [
                multiple && isGridView && (0, import_jsx_runtime6.jsx)(Flex, {
                  ...
                  height: "3.2rem",
                  children: (0, import_jsx_runtime6.jsx)(Checkbox, {
                    "aria-label": formatMessage({
...
var admin2 = {
  register(app) {
    app.addMenuLink({
      ...
      Component: () => import("./App-WYGUUKPA.js").then((mod) => ({
        default: mod.Upload
      })),
      position: 4
    });
    app.addSettingsLink("global", {
      ...
      async Component() {
        const { ProtectedSettingsPage } = await import("./SettingsPage-UGJDBSRA.js");
        return {
  ...
  return (0, import_jsx_runtime16.jsxs)(Dialog.Root, {
    ...
    children: [
      (0, import_jsx_runtime16.jsxs)(Field.Root, {
        ...
        name: name2,
        children: [
          (0, import_jsx_runtime16.jsx)(Checkbox, {
...
var index3 = {
  ...
  bootstrap(app) {
    ...
    app.addSettingsLink("global", {
      ...
      Component: () => import("./SettingsPage-PU3JZJOH.js").then((mod) => ({
        default: mod.ProtectedSettingsPage
      })),
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled("cms-content-releases")) {
      app.addMenuLink({
        ...
        Component: () => import("./App-M7SPSGLB.js").then((mod) => ({
          default: mod.App
        })),
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { ProtectedReleasesSettingsPage } = await import("./ReleasesSettingsPage-H5NM3CGR.js");
          return {
      ...
      app.widgets.register([
        {
          ...
          component: async () => {
            const { UpcomingReleasesWidget } = await import("./Widgets-463FXHKQ.js");
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseContentReleases } = await import("./PurchaseContentReleases-KVVONX57.js");
          return {
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled(FEATURE_ID)) {
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { Router } = await import("./router-OEK4MMER.js");
          return {
            default: Router
          };
        }
      ...
      app.widgets.register((widgets) => [
        ...widgets,
        {
          ...
          component: async () => {
            const { AssignedWidget } = await import("./Widgets-BOS3MT3J.js");
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseReviewWorkflows } = await import("./purchase-review-workflows-DBSFS7KM.js");
          return {
...
//# sourceMappingURL=chunk-BIZS4PPF.js.map
