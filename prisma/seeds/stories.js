...
export const storiesData = [
  {
    ...
    slug: "raimunda",
    regionId: "ARA",
    mediaUrl: "/images/story/raimunda.webp",
    content:`
...
Meu sítio  fica aqui mesmo, na Matatas. Quando eu comprei, só era terra. Mas agora já tenho mandioca plantada, tenho coco, tenho jaqueira e tenho pé de mangueira.
  ...
  // ------------------------------------------------------------------
  {
    ...
    slug: "silvia-helena",
    regionId: "ARA",
    mediaUrl: "/images/story/dita.webp",
    content:`
  ...
  // ------------------------------------------------------------------
  {
    ...
    slug: "ivanilde",
    regionId: "SAL",
    mediaUrl: "/images/story/ivanilde.webp",
    content:`
  ...
  `},
  {
    ...
    slug: "madalena",
    regionId: "GLO",
    mediaUrl: "/images/story/madalena.webp",
    content: `
  ...
  // ------------------------------------------------------------------
  {
    ...
    slug: "rosa",
    regionId: "GLO",
    mediaUrl: "/images/story/rosa.webp",
    content: `
  ...
  // ------------------------------------------------------------------
  {
    ...
    slug: "alba-rafaela",
    regionId: "NLO",
    mediaUrl: "/images/story/alba.webp",
    content: `
  ...
  // ------------------------------------------------------------------
  {
    ...
    slug: "edna-rodrigues",
    regionId: "SAL",
    mediaUrl: "/images/story/edna.webp",
    content: `
